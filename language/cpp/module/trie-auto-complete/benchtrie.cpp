...
void testStudent(string dict_filename) {
  ...
  cout << "\tTest 1: time taken: " << time_duration << " nanoseconds." << endl;
  ...
  results = dictionary_trie->predictCompletions("a", 10);
  time_duration = T.end_timer();
  cout << "\tTest 2: time taken: " << time_duration << " nanoseconds." << endl;
  ...
  time_duration = T.end_timer();
  cout << "\tTest 3: time taken: " << time_duration << " nanoseconds." << endl;
  ...
  time_duration = T.end_timer();
  cout << "\tTest 4: time taken: " << time_duration << " nanoseconds." << endl;
  ...
  cout << endl;
  cout << "\tTest 5: time taken: " << time_duration << " nanoseconds." << endl;
  ...
  if (response.compare("y") == 0) {
    ...
    while (getline(cin, prefix)) {
      ...
      cout << "\n\tUser Test: prefix= \"" << prefix << "\" num_completions= " << num_completions << endl;
      T.begin_timer();
      results = dictionary_trie->predictCompletions(prefix, num_completions);
      time_duration = T.end_timer();
      cout << "\tUser Test: time taken: " << time_duration << " nanoseconds." << endl;
