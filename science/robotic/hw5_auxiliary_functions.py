...
the parametrization of the segment to map to the corresponding point in the segment.
...
def haltonPointInSegment(n, base, q1, q2):
    ...
    # To Do: obtain pB the nth  point of the Halton sequence associated with the  prime 'base'
    pB = 0
    for i in range(n):
        j = i
        f = 1 / base
...
def isPointInConvexPolygon(q, P):
    ...
    :return: 0 if point is outside of polygon, 1 if point is on or inside the polygon
    """
