...
Geometry::Geometry(GLuint shader){
    this->shader = shader;
    textureID = Geometry::loadCubemap({"images/right.jpg", "images/left.jpg", "images/top.jpg", "images/base.jpg", "images/front.jpg", "images/back.jpg"});
}
...
void Geometry::draw()
{
    ...
    //printf("%s", glm::to_string(model).c_str());
