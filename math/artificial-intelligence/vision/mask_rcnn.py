...
config = 'data/mask_rcnn_inception_v2_coco_2018_01_28.pbtxt'
class_labels = 'data/coco_90.names'
confThreshold = 0.6
maskThreshold = 0.3
img_files = ['data/dog.jpg', 'data/traffic.jpg', 'data/sheep.jpg']
...
for f in img_files:
    ...
    for i in range(numDetections):
        ...
        if score > confThreshold:
            ...
            x1, y1, x2, y2 = int(w * box[3]), int(h * box[4]), int(w * box[5]),  int(h * box[6])
