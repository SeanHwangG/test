...
* /etc/systemd/resolved.conf: resolver is a set of routines in the C library that provide access to Internet DNS
  * /etc/systemd/resolved.conf.d/*.conf -> /run/systemd/resolved.conf.d/*.conf -> /usr/lib/systemd/resolved.conf.d/*.conf
  * Domains: space-separated list of domains, [ex]: **EMPTY**
